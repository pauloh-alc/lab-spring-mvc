...
public class JediController {
	...
	// No meu controller - eu determino qual método vai atender a determinada requisição?
	// Se for /jedi     ----> jedi() {...}
	// Se for /new-jedi ----> newJedi() {...} 
	// Portanto meu controlador vai interceptar determinadas requisições. 
